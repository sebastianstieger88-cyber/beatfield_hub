...
- `api/sync-warmups.js`: geschützter Notion -> Supabase Sync für die Warm-Up-Bibliothek
...
Empfohlen für die aktuelle Finisher-Datenbank:
- `NOTION_FINISHER_TITLE_FIELD = Name`
- `NOTION_FINISHER_TYPE_FIELD = Finisher-Typ`
- `NOTION_FINISHER_DURATION_FIELD = Dauer (Min)`
- `NOTION_FINISHER_INTENSITY_FIELD = Intensität`
- `NOTION_FINISHER_FORMAT_FIELD = Format`
- `NOTION_FINISHER_GROUP_SIZE_FIELD = Gruppengröße`
- `NOTION_FINISHER_OUTDOOR_FIELD = Outdoor geeignet`
- `NOTION_FINISHER_SCALING_FIELD = Skalierung`
- `NOTION_FINISHER_FAVORITE_FIELD = Favorit`
- `NOTION_FINISHER_FOCUS_AREAS_FIELD = Fokus`
- `NOTION_FINISHER_EQUIPMENT_FIELD = Ausrüstung`
- `NOTION_FINISHER_DESCRIPTION_FIELD = Beschreibung`

Empfohlen für die aktuelle Warm-Up-Datenbank:
- `NOTION_WARMUP_TITLE_FIELD = Name`
- `NOTION_WARMUP_TYPE_FIELD = Warm-up Typ`
- `NOTION_WARMUP_DURATION_FIELD = Dauer (Min)`
- `NOTION_WARMUP_INTENSITY_FIELD = Intensität`
- `NOTION_WARMUP_COMPLEXITY_FIELD = Komplexität`
- `NOTION_WARMUP_SPACE_FIELD = Platzbedarf`
- `NOTION_WARMUP_PARTICIPANT_COUNT_FIELD = Teilnehmerzahl`
- `NOTION_WARMUP_WEATHER_FIELD = Wetter-Fit`
- `NOTION_WARMUP_GOALS_FIELD = Ziel`
- `NOTION_WARMUP_FOCUS_AREAS_FIELD = Fokus`
- `NOTION_WARMUP_EQUIPMENT_FIELD = Equipment`
- `NOTION_WARMUP_COACHING_FIELD = Coaching Notes`
- `NOTION_WARMUP_DESCRIPTION_FIELD = Beschreibung`
- `Fokus`
- `Level`
- `Equipment`
- `Coaching`
